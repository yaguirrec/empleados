<div class="row mx-2">
    <div class="col-md-12">
        ...
        <div class="lista-roles">
            <h1 class="header text-center">Listado de roles</h1>
        ...
        <div class="rol-selecionado d-none">
            <h1 class="header text-center">Rol</h1>
            <div class="row">
            ...
            <div class="row mb-3">
                <a class="btn btn-info btn-sm text-white" id="asignarRol" role="button">Asignar Rol</a>
                <a class="btn btn-warning btn-sm text-white ml-4" id="cancelarRol" role="button">Regresar</a>
            </div>
            ...
            <div class="row empleadoRol d-none mb-4">
                <div class="col-md-4 offset-4">
                    ...
                    <button class="btn btn-success btn-block mt-2" id='btnAgregarEmpleadoRol'>Agregar</button>
                </div>
            </div>

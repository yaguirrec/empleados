            ...
            <div class="bg-gradient-primary p-5 text-white text-center mt-5 rounded-right">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control laborales" id="txtCURP">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="txtRFC">RFC</label>
                        <input type="text" class="form-control laborales" id="txtRFC">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control laborales" id="txtGenero">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="txtEdo" required>
                    </div>
                    <div class="form-group col-md-2">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtLocalidad" required>
                    </div>
                    <div class="form-group col-md-6">
            ...
            <div class="bg-gradient-success p-5 text-white text-center rounded-right mt-5">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="txtTelefono" maxlength="10" minlength="10" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="txtCelular">Celular</label>
                        <input type="text" class="form-control" id="txtCelular" maxlength="10" minlength="10" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtNcontacto" maxlength="10" minlength="10" required>
                    </div>
                </div>
            </div>
                ...
                <div id="beneficiario2Container">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="txtMunicipioB2" name="txtMunicipioB2" required>
                        </div>
                        <div class="form-group col-md-4">
